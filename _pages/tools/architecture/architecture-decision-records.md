...
permalink: "/tools/architecture/decision-records.html"
...
Mark Richards gibt in seinem [Vortrag "The Intersection of Architecture and Implementation"](/ri24-ddd-iai) eine [kurze Einführung in das Thema](https://youtube.com/watch?v=n6G5qtJHmgw&t=2420s).
...
ADRs sollten in einem leicht zugänglichen Repository gespeichert werden, etwa in einem Git-Repo oder einer Wiki-Seite, damit alle Teammitglieder jederzeit darauf zugreifen können. [Richards empfiehlt in seinem Vortrag](/ri24-ddd-iai), ADRs zunächst temporär einzuführen, um ihre Wirksamkeit als Kommunikationsmittel zu testen.
