...
metadate: "hide"
categories: [ Domain-Driven Design (DDD), Software Architecture, Architecture and Implementation Alignment, Collaboration, Governance, Architecture Decision Records(ADR), Fitnessfunktionen]
image: /assets/images/posts/Ri24-DDD-IAI_overview.png
visit: https://www.youtube.com/watch?v=n6G5qtJHmgw
---
**Sprecher**: Mark Richards

**Konferenz**: Domain-Driven Design Europe 2024, Amsterdam

**Datum**: 07.10.2024

## Zusammenfassung

Mark Richards’ Vortrag untersucht die entscheidende Abstimmung zwischen Softwarearchitektur und Implementierung und betont die Notwendigkeit von operativer, struktureller und restriktionsbasierter Ausrichtung, um effektive Systemleistung und Skalierbarkeit sicherzustellen. Er plädiert für eine enge Zusammenarbeit zwischen Architekten und Entwicklern mithilfe von Werkzeugen wie [Architecture Decision Records (ADRs)](/tools/architecture/decision-records.html) und Fitnessfunktionen, um Kommunikationslücken zu überbrücken und die architektonische Integrität zu wahren.

### Zitate

> Most of these cases are because the architecture is not lined up and aligned with the implementation and vice versa. [03:10](https://youtube.com/watch?v=n6G5qtJHmgw&t=190s)

> The logical architecture of a system shows how that system will work and how it’s coupled, the dependencies between these pieces of functionality. [17:30](https://youtube.com/watch?v=n6G5qtJHmgw&t=1050s)
...
> Why is more important than how. [40:30](https://youtube.com/watch?v=n6G5qtJHmgw&t=2430s)
...
> Architectural thinking empowers development teams to be more aware of architecture. [50:10](https://youtube.com/watch?v=n6G5qtJHmgw&t=3010s)
...
* [30:30](https://youtube.com/watch?v=n6G5qtJHmgw&t=1830s): Strukturelle Fitnessfunktionen mit ArcUnit und ähnlichen Tools.
